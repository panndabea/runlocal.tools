export const TOOL_REGISTRY = {
  ...
  tools: [
    ...
    },
    {
      ...
      category: "data",
      status: "live",
      route: "/data/json-to-csv/",
      run_url: "https://runlocal.tools/data/json-to-csv/",
      api_route: "/api/tools/json-to-csv",
      description: "Convert JSON arrays, objects, and row data into CSV in the browser.",
      runs_locally: true,
      free_to_use: true,
      receipts_supported: false,
      optional_receipts: false,
    ...
    },
    {
      ...
      run_url: "https://runlocal.tools/data/json-formatter/",
      api_route: "/api/tools/json-formatter",
      description: "Format, minify, and validate JSON locally in the browser.",
      runs_locally: true,
      free_to_use: true,
      receipts_supported: false,
      optional_receipts: false,
